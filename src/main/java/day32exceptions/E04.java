...
public class E04 {
    ...
    2) Code yazarken kirmizi alt cizgi seklinde alinan Exception lar da vardir, bunlara da "Compile Time Exception" denir
        ...
        1) throw  MethodOlusturma body si icinde throws ise MethodOlusturma parantezinden hemen sonra kullanilir
        2) throw MethodOlusturma body si icinde istenilen yerde istenildigi kadar kullanilir
            throws ise MethodOlusturma parantezinden hemen sonra sadece bir kere kullanilabilir
