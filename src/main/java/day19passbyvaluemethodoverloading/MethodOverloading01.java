...
public class MethodOverloading01 {
    ...
    3) Java icin "ismi" ve "parametreleri" ayni olan iki MethodOlusturma tamamen aynidir
    ...
    Method Overloading olustururken MethodOlusturma u static yada non-static yapmanin hicbir etkisi yoktur
    Method Overloading olustururken bodyi degistirmenin hicbir etkisi yoktur

    5) "private" methodlar overload edilebilir. Cunku MethodOlusturma overloading sadece bir class icinde olur
    private olmak ise baska classlara gidildiginde problem olusturur.

    6) static methodlar overload edilebilir,
    overloading yapmak icin (MethodOlusturma ismini degistirmeden) MethodOlusturma signature i degistiririz,
    dolayisiyla signature degistiginde yeni bir MethodOlusturma olusturmus oluruz, bu nedenle static olmasi birseyi degistirmez
     */
